        ...
        <div id="projects" className='projects'>
            <div className='projects_div'>
                ...
                <div className='projects-cards'>
                    ...
                    <ProjectCard key="2" name="Contract Insurance Provider" src="https://github.com/HAPPYS1NGH/Token-Insurance" github="https://github.com/HAPPYS1NGH/Insurance-Provider-Hardhat" description="This contract allows the people to insure their contracts with the funds.It also have a token insurance contract which will insure the tokens according to plan value for specific time. Whenever the price of asset falls , the claim can be made for the loss of amount of tokens" img="c-2" />
                    <ProjectCard key="3" name="Tenzies" src="https://happys1ngh.github.io/Tenzies/" github="https://github.com/HAPPYS1NGH/Tenzies" description="This is a Tenzies Game made while learning React where a player wins if all the boxes are done" img="c-3" />
                    <ProjectCard key="4" name="Happing Domain Service" src="https://replit.com/@HAPPYS1NGH/happy-domain" github="https://github.com/HAPPYS1NGH/happy-domains" description="This is a domain naming service just like ENS on polygon mumbai testnet which mints the nft for an address and records the value." img="c-4" />
                </div>
            </div>
        </div>
    )
